<template>
  <div class="flex justify-center items-center gap-6">
    ...
    <div>
      <div
        v-show="isAddingMenuActive"
        class="flex gap-3 absolute left-[50%] translate-x-[-50%] translate-y-[-70px]"
      >
        <div class="cursor-pointer">
          <img
            class="min-w-[56px]"
            src="../images/Navigation/icons/Income.svg"
            alt=""
          />
        </div>
        <div class="cursor-pointer translate-y-[-70px]">
          <img
            class="min-w-[56px]"
            src="../images/Navigation/icons/Transfer.svg"
            alt=""
          />
        </div>
        <div class="cursor-pointer">
          <img
            class="min-w-[56px]"
            src="../images/Navigation/icons/Expense.svg"
            alt=""
          />
        </div>
      </div>

      <div @click="activateMenu" class="cursor-pointer">
        <img
          class="min-w-[56px]"
          src="../images/Navigation/add-btn.svg"
          alt=""
        />
      </div>
    </div>
    ...
    <router-link to="/budget">
      ...
      >
        <path
          d="M28 15H17V4C19.8412 4.22837 22.5083 5.46063 24.5239 7.47614C26.5394 9.49166 27.7716 12.1588 28 15V15Z"
          fill="#C6C6C6"
        />
        <path
...
<script setup>
import { ref } from 'vue'
import { useTransactionsStore } from '../store/allTransactions.js'

const transactionsStore = useTransactionsStore()
const isAddingMenuActive = ref(false)
const addNewTransaction = () => {
  ...
  transactionsStore.addNewTransaction(newTransaction)
}

const activateMenu = () => {
  isAddingMenuActive.value = !isAddingMenuActive.value
}
</script>
<style>
.active {
